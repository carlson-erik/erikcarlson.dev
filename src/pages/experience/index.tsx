          ...
          <Container>
            ...
            <DetailContainer>
              ...
              <InformationContainer $flipFlexDirection>
                ...
                <BulletList>
                  ...
                  <li>
                    Mentor teammates in topics ranging from
                    Technical/Engineering skills to the Software Development
                    Life Cycle process.
                  </li>
                  <li>
                    Lead team technical/design discussions, user story
              ...
              <InformationContainer $flipFlexDirection>
                ...
                <BulletList>
                  ...
                  <li>
                    Investigate and implement fixes for security
                    vulnerabilities.
                  </li>
                </BulletList>
              </InformationContainer>
            ...
            <DetailContainer>
              ...
              <InformationContainer $flipFlexDirection>
                ...
                <BulletList>
                  ...
                  <li>
                    Implement and write automated tests for features in
                    Enterprise Data Visualization software.
                  </li>
                  <li>
            ...
            <DetailContainer>
              ...
              <InformationContainer $flipFlexDirection>
                ...
                <BulletList>
                  <li>
                    Participate in team design discussions, user story
                    refinement, and other re-occuring Agile planning meetings.
                  </li>
                  <li>
                    Implement and write automated tests for features in Customer
            ...
            <DetailContainer>
              ...
              <InformationContainer $flipFlexDirection>
                ...
                <BulletList>
                  <li>
                    Participate in team design discussions, user story
                    refinement, and amongst other re-occuring Agile planning
                    meetings.
                  </li>
                  <li>
